...
const I18N = {
  ...
  strings: {
    es: {
      ...
      'skills.aboutText': 'Construyo y despliego apps web full-stack con Spring Boot, React, TypeScript, Docker y Kubernetes. También trabajo con Python, Temporal, Supabase, Vercel, PostgreSQL, Java y más.',
    ...
    en: {
      ...
      'skills.aboutText': 'I build and deploy full-stack web apps with Spring Boot, React, TypeScript, Docker, and Kubernetes. I also work with Python, Temporal, Supabase, Vercel, PostgreSQL, Java and more.',
