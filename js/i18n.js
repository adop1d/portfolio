...
const I18N = {
  ...
  strings: {
    es: {
      ...
      'hero.features': 'Stack',
      'hero.featuresText': 'quarkus/vert.x · springboot · react.js · docker · k8s · temporal.io · vercel · supabase · postgresql',
      ...
      'cert.vertx.title': 'Eclipse Vert.x/Quarkus',
      'cert.vertx.summary': 'Programación reactiva y no bloqueante en la JVM con Vert.x.',
      ...
      'project.vitre.summary': 'Blog estilo red social con posts, comentarios, chat en tiempo real y perfiles. React, Supabase y Vercel.',
      ...
      'skills.aboutText': 'Construyo y despliego apps web full-stack con Spring Boot, Vert.x, React, TypeScript, Docker y Kubernetes. También trabajo con Python, Temporal, Supabase, Vercel, PostgreSQL, Java y más.',
    ...
    en: {
      ...
      'cert.vertx.title': 'Eclipse Vert.x/Quarkus',
      'cert.vertx.summary': 'Reactive, non-blocking programming on the JVM with Vert.x.',
      ...
      'projects.badge.repo': 'Repo',
      'project.vitre.summary': 'Social platform-like blog with posts, comments, realtime chat, and profiles. React, Supabase, and Vercel.',
      ...
      'skills.aboutText': 'I build and deploy full-stack web apps with Spring Boot, Vert.x, React, TypeScript, Docker, and Kubernetes. I also work with Python, Temporal, Supabase, Vercel, PostgreSQL, Java and more.',
