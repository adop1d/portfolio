const I18N = {
  ...
  strings: {
    es: {
      ...
      'project.auges.tut': 'Mi POS administrativo en la nube (AugesCloud), Página de presentación de la marca (personal) y co-desarrollador de AugeSGIntern (Programa Local).',
    ...
    en: {
      ...
      'project.auges.tut': 'My cloud-based admin POS (AugesCloud), personal brand landing page, and co-developer of AugeSGIntern (local program).',
